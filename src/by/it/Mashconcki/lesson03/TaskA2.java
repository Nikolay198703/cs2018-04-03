...
class TaskA2 {
    public static void main(String[] args) {
        String a = "Калі навагрудскія ўбачыш прасторы, Ракітнік разгалісты, нізкі,-";
        String b = "Каня супыні ля плужынскага бору, Каб глянуць на возера зблізку.";
        String c = "Гушчар лесу пахне чаборам і мёдам, Жывіцы настоем смалістым.";
        String d = "Там возера Свіцязь, як шыбіна люду, Ляжыць паміж дрэваў цяністых.";
        String e = "Калі пад'язджаеш начною парою І станеш да возера тварам,-";
        String f = "Мігцяць зоркі ў небе, мігцяць пад табою Мігціць там і месяцаў пара.";
